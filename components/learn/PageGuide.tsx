    ...
    <Card className="overflow-hidden">
      ...
      >
        <span className="flex items-center gap-2 text-13 font-medium text-ink">
          <span className="grid place-items-center h-5 w-5 rounded-pill border border-line bg-elevate/[0.05] text-ink-muted">
            ...
            {points.map((p, i) => (
              <li key={i} className="rounded-input border border-line glass-soft px-3 py-2.5">
                <div className="flex items-center gap-2">
                  <span className="grid place-items-center h-5 w-5 rounded-pill border border-line bg-elevate/[0.04] text-2xs font-mono text-ink-muted">
                    {i + 1}
                  </span>
